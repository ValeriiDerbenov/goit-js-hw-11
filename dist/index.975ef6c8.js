...
var _makeMarkupGallery = require("./js/makeMarkupGallery");
let page = 1;
let lightbox;
...
function onFormSubmit(evt) {
    ...
    if (!inputValue) return (0, _notiflixNotifyAio.Notify).info("Sorry, there are no images matching your search query. Please try again.");
    firstRenderMarkupGallery(inputValue);
}
function firstRenderMarkupGallery(searchIteam) {
    (0, _request.fetchImages)(searchIteam, page).then((response)=>{
        if (!response.hits.length) return (0, _notiflixNotifyAio.Notify).info("Unfortunately, there are not any matches. Try again, please");
        if (response.hits.length < 40) loadMoreBtn.classList.add("display-none");
        gallery.innerHTML = "";
        (0, _notiflixNotifyAio.Notify).info(`We have found ${response.totalHits} images.`);
        gallery.insertAdjacentHTML("beforeend", (0, _makeMarkupGallery.makeMarkupGallery)(response.hits));
        if (response.hits.length === 40) loadMoreBtn.classList.remove("display-none");
...
function renderMarkupGallery(search) {
    (0, _request.fetchImages)(search, page).then((response)=>{
        if (response.hits.length < 40) {
            (0, _notiflixNotifyAio.Notify).info("You've already reached the end of search results.");
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./js/request":"3ht5B","./js/makeMarkupGallery":"iAONk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}],"kaxSc":[function() {},{}],"3ht5B":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iAONk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeMarkupGallery", ()=>makeMarkupGallery);
function makeMarkupGallery(array) {
    return array.map((item)=>{
        const { tags , likes , views , comments , downloads , largeImageURL , webformatURL ,  } = item;
